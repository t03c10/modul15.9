    ...
    _createClass(User, [{
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: 'userDiv' },
                React.createElement("img", { className: 'userImg', src: this.props.user.avatar_url, style: { maxWidth: '100px' } }),
                React.createElement(
                    "p",
                    null,
                    React.createElement(
                        "a",
                        { className: 'userA', href: this.props.user.html_url, target: "_blank" },
